...
int main() {
    ...
    printf(CYAN "    > ^ <     " RESET);
    print_line(" İS:       ", "PatiOS - Yeni nesil mobil işletim sistemi");
    printf("             ");
    print_line(" Çekirdek:   ", kernel);
    printf("             ");
    print_line(" Açılış:   ", uptime);
    printf("             ");
    print_line(" Kabuk:    ", "pati@2.1");
    printf("             ");
    printf("%s             İşlemci:      %s%s\n", CYAN, YELLOW, cpu);
    printf("             ");
    print_line(" Bellek:   ", ram);
    printf("             ");
    print_line(" IPA:       ", ip);
    printf("             ");
    printf("%s             UMCI:   %s%s\n", CYAN, YELLOW, devid);
